...
<template>
  <VRow class="match-height">
    ...
    >
      ...
      >
        <VCardText>
          <code>v-list</code> component can contain an avatar, content, actions and much
          more.
        </VCardText>
    ...
    >
      ...
      >
        <VCardText>
          Use <code>density</code> prop to adjusts the spacing within the component.
    ...
    >
      ...
      >
        <VCardText>
          A <code>three-line</code> list with actions. Utilizing
          <code>v-list-group</code>, easily connect actions to your tiles.
        </VCardText>
    ...
    >
      ...
      >
        <VCardText>
          Using the <code>v-list-group</code> component you can create up to 2 levels in
          depth using the sub-group prop.
        </VCardText>
